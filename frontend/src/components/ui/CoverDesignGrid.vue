                ...
                <v-table>
                    ...
                    <tbody>
                        ...
                        >
                            ...
                            <td class="whitespace-nowrap" label="GeneratedBy">{{ val.generatedBy }}</td>
                            <td class="whitespace-nowrap" label="CreatedAt">{{ val.createdAt }}</td>
                            <td class="whitespace-nowrap" label="AI이미지생성 DALLE">
                                <AiDallEId :editMode="editMode" v-model="val.aiDallEId"></AiDallEId>
                            </td>
            ...
            >
                <v-card>
                    <v-toolbar
                        ...
                        height="50px"
                    >
                        <div style="color:white; font-size:17px; font-weight:700;">CoverDesign 등록</div>
                        <v-spacer></v-spacer>
                        <v-icon
                            color="white"
                            small
            ...
            >
                <v-card>
                    <v-toolbar
                        ...
                        height="50px"
                    >
                        <div style="color:white; font-size:17px; font-weight:700;">CoverDesign 수정</div>
                        <v-spacer></v-spacer>
                        <v-icon
                            color="white"
                            small
